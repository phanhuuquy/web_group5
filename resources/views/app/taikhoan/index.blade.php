    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <img src="storage/images/register.png" class="img-fluid" alt="Sample image">
            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="card-body">
                            <form action="/tai-khoan/sua" method="POST">
                                ...
                                <div class="form-outline mb-4">
                                    <input type="input" class="form-control" name="sdt" value="{{ $data['sdt'] }}"
                                        required />
                                ...
                                <a href="/" type="button" class="btn btn-info">Quay lại</a>
