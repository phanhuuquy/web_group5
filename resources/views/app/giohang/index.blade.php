            ...
            <tbody>
                ...
                <tr>
                    ...
                    <form action="/gio-hang/cap-nhat" method="POST">
                        ...
                        <td><b>{{number_format($giohang['so_luong'] * $giohang['don_gia'])}} VNĐ<b>
                        </td>
                        <td>
                            <button type="submit" class="btn btn-info">Cập nhật</button>

                            <a href="/gio-hang/xoa/{{$id}}" onclick="return confirm('Bạn có thật sự muốn xóa ?');" type="button"
