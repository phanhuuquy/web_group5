                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseThree" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item">
                                                <a href="{{ request()->url() }}?from=0&to=300000" class="text-dark">
                                                    < 300,000 VNĐ</a>
                                            </li>
                                            <li class="list-group-item">
                                                <a href="{{ request()->url() }}?from=300000&to=500000"
                                                    class="text-dark">300,000 ~ 500,000
                                                    VNĐ</a>
                                            </li>
                                            <li class="list-group-item">
                                                <a href="{{ request()->url() }}?from=500000&to=700000"
                                                    class="text-dark">500,000 ~ 700,000
                                                    VNĐ</a>
                                            </li>
                                            <li class="list-group-item">
                                                <a href="{{ request()->url() }}?from=700000&to=1000000"
                                                    class="text-dark">700,000 ~
                                                    1,000,000 VNĐ</a>
                                            </li>
                                            <li class="list-group-item">
                                                <a href="{{ request()->url() }}?from=1000000&to=1500000"
                                                    class="text-dark">1,000,000 ~
                                                    1,500,000 VNĐ</a>
                                            </li>
                                            <li class="list-group-item">
                                                <a href="{{ request()->url() }}?from=1500000&to=2000000"
                                                    class="text-dark">1,500,000 ~
                                                    2,000,000 VNĐ</a>
                                            </li>
                                            <li class="list-group-item">
                                                <a href="{{ request()->url() }}?from=2000000" class="text-dark">> 2,000,000
                                                    VNĐ</a>
                                            </li>
                                        </ul>
                                    </div>
