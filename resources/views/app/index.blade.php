...
<head>
    ...
    <title> SHOP</title>
    <link rel="shortcut icon" type="image/x-icon" href="{{ URL('storage/images/icon-logo.png') }}">
...
<body style="padding: 0; margin: 0;">
    <button onclick="topFunction()" id="myBtn" title="Go to top"><img
            src="{{ URL('storage/images/scroll-top.png') }}" height="40"></button>
    <!-- Header -->
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand me-2" href="/"><img src="{{ URL('storage/images/logo.png') }}" height="35"
                    alt=" SHOP" loading="lazy"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarButtons">
                ...
                <div class="d-flex align-items-center float-right">
                    ...
                    <a
                        href="{{ Auth::user()?->id_phan_quyen === '3' ? route('gianhang.dangky') : (Auth::user()?->id_phan_quyen === '2' ? route('admin.index') : '#') }}">
                        <button type="button" class="btn btn-link px-3 me-2">CỬA HÀNG</button>
                    </a>
                    <a href="#"><button type="button" class="btn btn-link px-3 me-2">GIỚI
                            THIỆU</button></a>
                    ...
                    <a href="/gio-hang" data-mdb-toggle="tooltip" data-mdb-placement="bottom"
                        title="Giỏ hàng của bạn"><i class="fas fa-shopping-cart"></i></a><span class="cart-qty"
                    ...
                    @else
                        <a class="btn btn-outline-primary btn-rounded" href="{{ route('login') }}">ĐĂNG
                            NHẬP</a>
                        &ensp;
                        <a class="btn btn-primary btn-rounded" href="{{ route('register') }}">ĐĂNG KÝ MIỄN
                            PHÍ</a>
                    @endif
            ...
            <div class="container text-center text-md-start mt-5">
                <div class="row mt-3">
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <p><i class="fas fa-phone me-3"></i> +84 999999999</p>
                    </div>

                    <div class="col-md-3 col-lg-4 col-xl-2 mx-auto mb-4">
                        <h6 class="text-uppercase fw-bold mb-4">Tài khoản</h6>

                        <p><a href="{{ route('register') }}" class="text-reset"><i
                                    class="fas fa-angle-right"></i>&nbsp;Đăng ký</a></p>
                        <p><a href="{{ route('login') }}" class="text-reset"><i
        ...
        <section class=" justify-content-center justify-content-lg-between p-4 border-top"
            ...
            <div class="text-center me-5 d-none d-lg-block">
                <span class="text-center text-white">© 2021 Bản quyền thuộc về:
                    <a class="text-white" href="/">&ensp; SHOP - Phan Văn Bằng</a>
                </span>
            </div>
        </section>
    </footer>
