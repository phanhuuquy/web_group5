<div id="carouselBasicExample" class="carousel slide carousel-fade" data-mdb-ride="carousel">
	...
	<div class="carousel-inner">
		<div class="carousel-item active">
			<img src="{{ URL('storage/images/banner1.jpg') }}" class="d-block w-100" alt="..."/>

			<div class="carousel-caption d-none d-md-block">
				<h5> Shop</h5>
				<p>Mua sắm  sản phẩm mà bạn mơ ước.</p>
			</div>
		</div>

		<div class="carousel-item">
			<img src="{{ URL('storage/images/banner2.jpg') }}" class="d-block w-100" alt="..."/>
			<div class="carousel-caption d-none d-md-block">
				<h5> Shop</h5>
				<p>Mang lại cho bạn những  sản phẩm chất lượng nhất.</p>
			</div>
		</div>
