                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-10 col-lg-7 col-xl-7 d-flex align-items-center order-1 order-lg-1">
                                <div class="text-center">
                                  <a href="/"><img src="{{ URL('storage/images/logo-black.png') }}"></a>
                                  <!-- <h4 >Restaurant Manager</h4> -->

                                  <img src="{{ URL('storage/images/login.png') }}" class="img-fluid" alt="Sample image">
                                  <p class="mt-1 mb-2 pb-1">Chúng tôi giúp bạn mua sắm mình yêu thích.</p>
                              </div>
                          ...
                          <div class="col-md-10 col-lg-5 col-xl-5 order-2 order-lg-2">
                            ...
                            <form class="mx-1 mx-md-4" method="POST" action="{{ route('auth.checkLogin') }}">
                                ...
                                <div class="d-flex flex-row align-items-center mb-4">
                                    <div class="form-outline flex-fill mb-0">
                                        <input class="form-control" id="auth" type="email" name="email" value="{{ old('email') }}" required autofocus/>
