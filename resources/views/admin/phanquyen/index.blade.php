                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/admin/phanquyen/sua/{{$phanquyen['id_phan_quyen']}}" type="button" class="btn btn-warning btn-rounded">Sửa</a>
                            <a href="/admin/phanquyen/xoa/{{$phanquyen['id_phan_quyen']}}" onclick="return confirm('Bạn có thật sự muốn xóa ?');" type="button"
