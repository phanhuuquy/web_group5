                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/admin/taikhoan/sua/{{$user['id']}}" type="button" class="btn btn-warning btn-rounded">Sửa</a>
                            <a href="/admin/taikhoan/xoa/{{$user['id']}}" onclick="return confirm('Bạn có thật sự muốn xóa ?');" type="button"
