                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/admin/khuyenmai/sua/{{$khuyenmai['id_khuyen_mai']}}" type="button" class="btn btn-warning btn-rounded">Sửa</a>
                            <a href="/admin/khuyenmai/xoa/{{$khuyenmai['id_khuyen_mai']}}" onclick="return confirm('Bạn có thật sự muốn xóa ?');" type="button"
